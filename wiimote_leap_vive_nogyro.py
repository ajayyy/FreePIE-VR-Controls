...
def vive_controller():
	...
	if pressed == 0: #tracking (not recentering)
		...
		METER_TO_MM = 1100 #scales from meters
		...
		hydra[0].yaw = leap.rightyaw*1.1
		hydra[0].pitch = -leap.rightpitch*1.05
		hydra[0].roll = 0.9

		hydra[1].yaw = leap.leftyaw*1.1
		hydra[1].pitch = -leap.leftpitch*1.05
		hydra[1].roll = -0.9
